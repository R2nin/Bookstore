  ...
  <body>
    ...
    <div class="container" style="margin-top: none">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item ">
            <a class="nav-link  text-white" href="<?php echo APPURL; ?>">Contact</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active  text-white" aria-current="page" href="<?php echo APPURL; ?>"><i class="fas fa-shopping-cart"></i>(2)</a>
            </li>
            <li class="nav-item">
